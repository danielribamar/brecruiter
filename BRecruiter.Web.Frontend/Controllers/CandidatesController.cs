...
namespace BRecruiter.Web.Frontend.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BirthDate,SalaryExpectations,Observations")] Candidate candidate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BirthDate,SalaryExpectations,Observations")] Candidate candidate)
        {
            if (id != candidate.Id)
            {
                return NotFound();
